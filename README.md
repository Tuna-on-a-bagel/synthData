...
| --------------- | ----------- | ---------- | ------- | 
| `convertVertices()` | Project some set of 3D coordinates onto a 2D plane, used to project list of bpy object vertices onto the camera image plane |`scene` bpy.context.scene <br> `cam` blender camera object  `obj` blender object  `resolutionX` pixelCount X `resolutionY` pixelCount Y | `1e-6` |  
